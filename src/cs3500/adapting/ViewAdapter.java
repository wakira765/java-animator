...
public class ViewAdapter implements IView {
  ...
  /**
   * We had one method that handled pausing and playing since its just flipping a boolean. However,
   * the provider had separate methods. Throwing an exception is not ideal.
   */
  @Override
