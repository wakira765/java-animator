...
public class CommandFactory {
  ...
  public void set() {
    ...
    commands.put("loop", (IView v, IAnimation m) -> {
      return new Loop(v, m);
    });
    commands.put("pause resume", (IView v, IAnimation m) -> {
      return new PauseResume(v, m);
    });
    commands.put("start", (IView v, IAnimation m) -> {
      return new Start(v, m);
    });
    commands.put("restart", (IView v, IAnimation m) -> {
      return new Restart(v, m);
    });
    commands.put("speed up", (IView v, IAnimation m) -> {
      return new ToggleSpeed(v, m, 1);
    });
    commands.put("slow down", (IView v, IAnimation m) -> {
      return new ToggleSpeed(v, m, -1);
    });
    commands.put("Add Shape", (IView v, IAnimation m) -> {
      return new AddShape(v, m);
    });
    commands.put("Remove Shape", (IView v, IAnimation m) -> {
      return new RemoveShape(v, m);
    });
    commands.put("Add Mod Frame", (IView v, IAnimation m) -> {
      return new AddModFrame(v, m);
    });
    commands.put("Remove Frame", (IView v, IAnimation m) -> {
      return new RemoveFrame(v, m);
    });

    //commands added for provider's implementation
    commands.put("Play Button", (IView v, IAnimation m) -> {
      return new Play(v, m);
    });
    commands.put("Pause Button", (IView v, IAnimation m) -> {
      return new Pause(v, m);
    });
    commands.put("Restart Button", (IView v, IAnimation m) -> {
      return new Restart(v, m);
    });
