...
public class ControllerTest {
  ...
  /**
   * <p>Represents a mock view that implements an IView. The mock view is used to check if the
   * correct methods are called by the controller in reponse to an action/callback.
   *
   ...
   * and if this matches our expectation. However, for our purposes we kept it as booleans.</p>
   */
